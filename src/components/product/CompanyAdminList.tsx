...
export const CompanyAdminList = () => {
  ...
  const [removeUserFromAdmin] = useRemoveFromAdminMutation();
  ...
  const actions: Action<IMembership>[] = [
    ...
    },
    {
      ...
      onClick: (membership) => {
        removeUserFromAdmin(membership.id);
      },
      confirm: {
        title: t("dialog.deleteConfirmTitle"),
        description: t("dialog.deleteAdminConfirmMessage"),
      },
      hide: !isOwner,
    },
  ];
